...
import 'package:royal_task/features/home/presentation/painters/background_painter.dart';
import 'package:royal_task/features/home/presentation/widgets/app_bar_action.dart';
...
class _ProductDetailsPageState extends State<ProductDetailsPage> {
  ...
  Widget build(BuildContext context) {
    final Product product =
        serviceLocator<HomeBloc>().getProductById(widget.productId);
    return Scaffold(
      appBar: AppBar(
        leading: Padding(
